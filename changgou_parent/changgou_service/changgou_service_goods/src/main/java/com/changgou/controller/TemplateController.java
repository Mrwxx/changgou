...
public class TemplateController {
    ...
    public Result<Template> findByCategoryId(@PathVariable(value = "id") Integer id){
        ...
        return new Result<>(true, StatusCode.OK, "根据分类查询模板数据", template);
    }
    ...
    public Result<PageInfo> findPage(@PathVariable  int page, @PathVariable  int size){
        ...
        return new Result<PageInfo>(true,StatusCode.OK,"分页查询template成功",pageInfo);
    }
    ...
    public Result<List<Template>> findList(@RequestBody(required = false) @ApiParam(name = "Template对象",value = "传入JSON数据",required = false) Template template){
        ...
        return new Result<List<Template>>(true,StatusCode.OK,"条件查询template成功",list);
    }
    ...
    public Result delete(@PathVariable Integer id){
        ...
        return new Result(true,StatusCode.OK,"根据Id删除template成功");
    }
    ...
    public Result<Template> findById(@PathVariable Integer id){
        ...
        return new Result<Template>(true,StatusCode.OK,"根据Id查询template成功",template);
    }
    ...
    public Result<List<Template>> findAll(){
        ...
        return new Result<List<Template>>(true, StatusCode.OK,"查询所有template成功",list) ;
    }
}
