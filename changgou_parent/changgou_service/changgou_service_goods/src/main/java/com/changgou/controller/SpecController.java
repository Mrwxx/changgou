...
public class SpecController {
    ...
    public Result<List<Spec>> findByCategoryId(@PathVariable(value = "id") Integer categoryId){
        ...
        return new Result<>(true, StatusCode.OK, "根据分类ID查询规格列表", specs);
    }
    ...
    public Result<PageInfo> findPage(@PathVariable  int page, @PathVariable  int size){
        ...
        return new Result<PageInfo>(true,StatusCode.OK,"分页查询spec成功",pageInfo);
    }
    ...
    public Result<List<Spec>> findList(@RequestBody(required = false) @ApiParam(name = "Spec对象",value = "传入JSON数据",required = false) Spec spec){
        ...
        return new Result<List<Spec>>(true,StatusCode.OK,"条件查询spec成功",list);
    }
    ...
    public Result delete(@PathVariable Integer id){
        ...
        return new Result(true,StatusCode.OK,"根据Id删除spec成功");
    }
    ...
    public Result update(@RequestBody @ApiParam(name = "Spec对象",value = "传入JSON数据",required = false) Spec spec,@PathVariable Integer id){
        ...
        return new Result(true,StatusCode.OK,"根据Id修改spec成功");
    }
    ...
    public Result<Spec> findById(@PathVariable Integer id){
        ...
        return new Result<Spec>(true,StatusCode.OK,"根据Id查询Spec成功",spec);
    }
    ...
    public Result<List<Spec>> findAll(){
        ...
        return new Result<List<Spec>>(true, StatusCode.OK,"查询所有Spec成功",list) ;
    }
}
