...
public class SpuController {
    ...
    public Result restore(@PathVariable Long id){
        ...
        return new Result(true, StatusCode.OK, "逻辑删除的商品恢复");
    }
    ...
    public Result logicDelete(@PathVariable Long id){
        ...
        return new Result(true, StatusCode.OK, "逻辑删除商品");
    }
    ...
    public Result pull(@PathVariable Long id){
        spuService.pull(id);
        return new Result(true, StatusCode.OK, "下架商品");
    }
    ...
    public Result<Goods> findGoodsById(@PathVariable(value = "id") Long spuId){
        ...
        return new Result<>(true, StatusCode.OK, "根据SPU ID查询goods成功", goods);
    }
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "Spu对象",value = "传入JSON数据",required = false) Spu spu, @PathVariable  int page, @PathVariable  int size){
        ...
        return new Result<>(true,StatusCode.OK,"条件分页查询spu成功",pageInfo);
    }
    ...
    public Result<PageInfo> findPage(@PathVariable  int page, @PathVariable  int size){
        ...
        return new Result<PageInfo>(true,StatusCode.OK,"分页查询spu成功",pageInfo);
    }
    ...
    public Result<List<Spu>> findList(@RequestBody(required = false) @ApiParam(name = "Spu对象",value = "传入JSON数据",required = false) Spu spu){
        ...
        return new Result<List<Spu>>(true,StatusCode.OK,"条件查询spu成功",list);
    }
    ...
    public Result update(@RequestBody @ApiParam(name = "Spu对象",value = "传入JSON数据",required = false) Spu spu,@PathVariable Long id){
        ...
        return new Result(true,StatusCode.OK,"根据Id修改spu成功");
    }
    ...
    public Result add(@RequestBody  @ApiParam(name = "Spu对象",value = "传入JSON数据",required = true) Spu spu){
        //调用SpuService实现添加Spu
        spuService.add(spu);
        return new Result(true,StatusCode.OK,"添加spu成功");
    }
    ...
    public Result<List<Spu>> findAll(){
        ...
        return new Result<List<Spu>>(true, StatusCode.OK,"查询所有spu成功",list) ;
    }
}
