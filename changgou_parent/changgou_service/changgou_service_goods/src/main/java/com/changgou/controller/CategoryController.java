...
public class CategoryController {
    ...
    public Result<List<Category>> findByParentId(@PathVariable(value = "pid") Integer pid){
        ...
        return new Result<List<Category>>(true, StatusCode.OK, "查询子分类节点成功", categories);
    }
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "Category对象",value = "传入JSON数据",required = false) Category category, @PathVariable  int page, @PathVariable  int size){
        ...
        return new Result<>(true,StatusCode.OK,"条件分页查询分类成功",pageInfo);
    }
    ...
    public Result<PageInfo> findPage(@PathVariable  int page, @PathVariable  int size){
        ...
        return new Result<PageInfo>(true,StatusCode.OK,"分页查询分类成功",pageInfo);
    }
    ...
    public Result<List<Category>> findList(@RequestBody(required = false) @ApiParam(name = "Category对象",value = "传入JSON数据",required = false) Category category){
        ...
        return new Result<List<Category>>(true,StatusCode.OK,"条件查询分类成功",list);
    }
    ...
    public Result delete(@PathVariable Integer id){
        ...
        return new Result(true,StatusCode.OK,"根据Id删除分类成功");
    }
    ...
    public Result update(@RequestBody @ApiParam(name = "Category对象",value = "传入JSON数据",required = false) Category category,@PathVariable Integer id){
        ...
        return new Result(true,StatusCode.OK,"根据Id修改分类成功");
    }
    ...
    public Result<List<Category>> findAll(){
        ...
        return new Result<List<Category>>(true, StatusCode.OK,"查询所有分类成功",list) ;
    }
}
