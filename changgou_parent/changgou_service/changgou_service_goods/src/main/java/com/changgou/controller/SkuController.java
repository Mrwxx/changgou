...
public class SkuController {
    ...
    public Result  decrCount(@RequestParam Map<Long, Integer> decrmap){
        ...
        return new Result(true, StatusCode.OK, "删除商品库存成功");
    ...
    public Result<List<Sku>> findByStatus(@PathVariable String status){
        ...
        return new Result<>(true, StatusCode.OK, "根据状态查询SKU成功", list);
    }
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "Sku对象",value = "传入JSON数据",required = false) Sku sku, @PathVariable  int page, @PathVariable  int size){
        ...
        return new Result<>(true,StatusCode.OK,"条件分页查询SKU成功",pageInfo);
    }
    ...
    public Result<PageInfo> findPage(@PathVariable  int page, @PathVariable  int size){
        ...
        return new Result<PageInfo>(true,StatusCode.OK,"分页查询SKU成功",pageInfo);
    }
    ...
    public Result<List<Sku>> findList(@RequestBody(required = false) @ApiParam(name = "Sku对象",value = "传入JSON数据",required = false) Sku sku){
        ...
        return new Result<List<Sku>>(true,StatusCode.OK,"条件查询SKU成功",list);
    }
    ...
    public Result delete(@PathVariable Long id){
        ...
        return new Result(true,StatusCode.OK,"根据Id删除SKU成功");
    }
    ...
    public Result update(@RequestBody @ApiParam(name = "Sku对象",value = "传入JSON数据",required = false) Sku sku,@PathVariable Long id){
        ...
        return new Result(true,StatusCode.OK,"根据Id修改SKU成功");
    }
    ...
    public Result<Sku> findById(@PathVariable Long id){
        ...
        return new Result<Sku>(true,StatusCode.OK,"根据Id查询SKU成功",sku);
    }
    ...
    public Result<List<Sku>> findAll(){
        ...
        return new Result<List<Sku>>(true, StatusCode.OK,"查询所有SKU成功",list) ;
    }
}
